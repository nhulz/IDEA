...
$GLOBALS['FW_URL_OLD'] = 'http://localhost:8888/idea';
$GLOBALS['FW_URL_NEW'] = '';
$GLOBALS['FW_PACKAGE_NAME'] = '20140813_idea_website_53fa52360a95f6625140824205934_archive.zip';
$GLOBALS['FW_PACKAGE_NOTES'] = '';
$GLOBALS['FW_SECURE_NAME'] = '20140813_idea_website_53fa52360a95f6625140824205934';
$GLOBALS['FW_DBHOST'] = 'localhost';
$GLOBALS['FW_DBHOST'] = empty($GLOBALS['FW_DBHOST']) ? 'localhost' : $GLOBALS['FW_DBHOST'];
$GLOBALS['FW_DBNAME'] = 'idea';
...
$GLOBALS['FW_BLOGNAME'] = 'IDEA';
$GLOBALS['FW_WPROOT'] = '/Applications/MAMP/htdocs/idea/';
$GLOBALS['FW_DUPLICATOR_VERSION'] = '0.5.6';
