...
function mfma_relocator_init() {
    ...
    wp_enqueue_style('media-file-manager-advanced-admin-jquery-ui-css', plugins_url() . '/media-file-manager-advanced/includes/jquery-ui/jquery-ui.min.css', false, PLUGIN_VERSION, false);
    wp_enqueue_style('media-file-manager-advanced-admin-style-css', plugins_url() . '/media-file-manager-advanced/style.css', false, PLUGIN_VERSION, false);
}
